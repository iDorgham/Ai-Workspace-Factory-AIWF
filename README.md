...
```mermaid
graph TD
    subgraph GLOBAL_ZONE["🌐 Global Shards (Hetzner/AWS/Vercel)"]
        G1[Orchestration Logic]
        G2[Public Metadata]
    end
    subgraph MENA_ZONE["🛡️ MENA-Soil Shards (Law 151 Compliant)"]
        M1[Sensitive User Data]
        M2[Local Financial Shards]
    end
...
graph LR
    ...
    style DEP fill:#69f,stroke:#333,stroke-width:2px
