...
**Behavior:**
- Looks up command in commands-multi-tool.md
...
def execute_command(user_input):
    ...
    # Step 5: Route to appropriate handler (in tool-router.md)
...
Once flags are parsed and validated, they're passed to tool-router.md for execution decisions.
