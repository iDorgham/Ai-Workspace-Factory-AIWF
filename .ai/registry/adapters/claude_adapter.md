...
guide-agent context injection:
{
  ...
  "agent": "creator-agent",
  "context": {
    "brand_voice": "content/sovereign/reference/brand-voice/style_rules.md (loaded)",
    "keyword_map": "content/sovereign/_references/keyword_maps.md (loaded)",
    "competitor_data": "content/sovereign/scraped/[top-3]/scraped/content/blog/ (path pointers)",
    "market_positioning": "content/sovereign/reference/market_positioning.md (loaded)"
  },
  "parameters": {
...
1. Check `.ai/data_ownership.md` to confirm write permission
...
|-------|-------|----------|
| `brand_voice_missing` | No `style_rules.md` | Run `/brand` first |
...
**Example CLI Usage:** (See `claude_code_adapter.md` for true CLI support)  
...
- ✅ Respects `.ai/data_ownership.md` for file writes
