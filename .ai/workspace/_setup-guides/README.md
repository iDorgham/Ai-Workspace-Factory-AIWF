...
|------|------|------|---------|
| 1 | `IMPLEMENTATION-CHECKLIST.md` | 15 min | Phase activation checklist |
| 2 | `PHASE-1-SETUP-GUIDE.md` | 10 min | Enable multi-tool support |
| 3 | `GUIDE-AGENT-SYSTEM-PROMPT-ADDENDUM.md` | 5 min | Update Claude system prompt |
| 4 | `GUIDE-AGENT-SYSTEM-PROMPT-ADDENDUM-PHASE2A.md` | 5 min | Enable CLI layer |
...
### `GUIDE-AGENT-SYSTEM-PROMPT-ADDENDUM.md`
...
### `GUIDE-AGENT-SYSTEM-PROMPT-ADDENDUM-PHASE2A.md`
...
1. Read `IMPLEMENTATION-CHECKLIST.md` (2 min)
2. Check prerequisites and activate features
3. Run verification command
4. **Ready to use!**

### Adding a New Tool (e.g., Qwen)
1. Reference `PHASE-1-SETUP-GUIDE.md` (tool integration section)
2. Add tool adapter in `../04-tool-adapters/`
3. Update `tool-registry.json`
4. Update `commands-multi-tool.md` with rankings
5. Run tests in `../08-testing/`
6. Done!

### Onboarding a New Team Member
1. Have them read `IMPLEMENTATION-CHECKLIST.md` (overview)
2. Walk through `PHASE-1-SETUP-GUIDE.md` together
...
1. Copy `GUIDE-AGENT-SYSTEM-PROMPT-ADDENDUM.md` content
2. Append to your system prompt
3. For CLI features, also append `GUIDE-AGENT-SYSTEM-PROMPT-ADDENDUM-PHASE2A.md`
...
- [ ] Brand positioning filled in (`../06-brand-content/sovereign/reference/market-positioning.md`)
...
| Commands not routing | Review `../03-cli-layer/tool-router.md` |
| Permission denied on file | Check `../02-agent-contracts/data-ownership-multi-tool.md` |
...
- Periodically review `IMPLEMENTATION-CHECKLIST.md` for maintenance
