...
✅ .ai/cli-layer/flag_parser.md        ← parsing logic
✅ .ai/cli-layer/tool_router.md        ← routing logic
```
...
**See:** `.ai/GUIDE_AGENT_SYSTEM_PROMPT_ADDENDUM.md` (existing Phase 1 section)
