...
READ: .ai/cli-layer/tool-router.md    ← routing logic
```
```

### 2. Guide-Agent System Prompt (New Section)
**File:** `.ai/GUIDE-AGENT-SYSTEM-PROMPT-ADDENDUM.md`
...
**File:** `.ai/commands-multi-tool.md`
...
**File:** `.ai/data-ownership-multi-tool.md`
...
- [ ] Update commands-multi-tool.md with 6-tool rankings
