...
**Time:** ~40 min  
**Input:** `.ai/cli-layer/tool-router.md` (pseudocode)  
...
**Output:** `.ai/commands-multi-tool.md` (tool rankings per command)
...
**Output:** `.ai/INTEGRATION-VERIFICATION.md` (go/no-go check)
...
- [ ] `.ai/commands-multi-tool.md` (command → tool rankings)
...
- [ ] `.ai/INTEGRATION-VERIFICATION.md` (checklist)
