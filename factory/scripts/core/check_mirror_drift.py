...
# factory/scripts/core/check_mirror_drift.py → repo root
...
def log_to_ledger(payload: dict) -> None:
...
def main() -> int:
    ...
    if args.json:
        ...
        if status == "fail":
            print("CRITICAL DRIFT: .ai registry out of sync with library. Run /git sync to repair.")
