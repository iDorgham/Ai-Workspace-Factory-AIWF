...
mappings = {
    ...
    "factory/library/_legacy_pillars/06-branding": "factory/library/20-content-strategy/06-branding",
    ...
    "factory/library/_legacy_pillars/02-web-platforms": "factory/library/30-web-platforms/02-web-platforms",
