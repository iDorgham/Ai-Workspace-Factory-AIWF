...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'pr-template' node within the 10-operations-qa ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the pr-template requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform pr-template-specific tasks autonomously.
