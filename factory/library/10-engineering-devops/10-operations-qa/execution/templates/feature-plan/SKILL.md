...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'feature-plan' node within the 10-operations-qa ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the feature-plan requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform feature-plan-specific tasks autonomously.
