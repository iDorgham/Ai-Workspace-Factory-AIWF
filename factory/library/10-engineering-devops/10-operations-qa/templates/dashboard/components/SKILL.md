...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'components' node within the 10-operations-qa ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the components requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform components-specific tasks autonomously.
