...
id: agents:05-data-analytics/analysis/Tutor
version: 10.0.0
...
1. `.ai/memory/user-learning-profile.md` — expertise label, facts, study queue, experience table
2. `.ai/memory/learning-progress.md` — concept checklist
...
- **Level:** Foundation
- **Saved to:** `.ai/memory/learning-progress.md` + signal logged in `.ai/memory/user-learning-profile.md` if expertise or facts shifted
...
```markdown
# .ai/memory/learning-progress.md
...
---
* | Writes to: `.ai/memory/learning-progress.md`, `.ai/memory/user-learning-profile.md`*
