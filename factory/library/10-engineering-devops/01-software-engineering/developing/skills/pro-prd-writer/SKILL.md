...
2. **Single source of truth**
   - Ensure there is **one canonical PRD per scope** (e.g. `PRD_v7.0.md` for Workspace Factory core).
...
3. **Tight alignment with reality**
   - Before editing, skim:
     ...
     - `docs/development/initiatives/WSF_CONFIG.md`
...
5. **Must-have for gated communities**
   - Always ask: “Does this feature move Workspace Factory closer to a **must-have security tool** for gated communities?”
   - Emphasize:
