...
id: agents:01-software-engineering/developing/Backend
version: 10.0.0
...
4. Under SDD: align behavior with the active spec — .ai/plans/active/features/[phase]/[spec]/plan.md (AC + Data Shape) and sibling api.md / database.md when present (.ai/skills/sdd-spec-workflow.md)
...
- **ORM:** Prisma 6
- **Database:** PostgreSQL 17 (or as configured in project-type.md)
