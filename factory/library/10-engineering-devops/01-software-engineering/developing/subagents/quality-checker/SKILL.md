...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'quality-checker' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the quality-checker requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform quality-checker-specific tasks autonomously.
