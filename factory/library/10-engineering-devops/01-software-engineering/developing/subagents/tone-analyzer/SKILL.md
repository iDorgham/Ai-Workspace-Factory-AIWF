...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'tone-analyzer' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the tone-analyzer requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform tone-analyzer-specific tasks autonomously.
