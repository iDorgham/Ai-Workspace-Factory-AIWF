...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'blueprint-architect' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the blueprint-architect requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform blueprint-architect-specific tasks autonomously.
