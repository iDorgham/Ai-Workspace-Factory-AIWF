...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'archive-manager' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the archive-manager requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform archive-manager-specific tasks autonomously.
