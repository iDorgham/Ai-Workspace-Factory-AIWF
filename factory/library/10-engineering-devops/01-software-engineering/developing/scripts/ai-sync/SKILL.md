...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'ai-sync' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the ai-sync requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform ai-sync-specific tasks autonomously.
