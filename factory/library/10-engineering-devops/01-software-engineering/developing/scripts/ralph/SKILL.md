...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'ralph' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the ralph requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform ralph-specific tasks autonomously.
