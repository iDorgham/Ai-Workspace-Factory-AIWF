...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'antigravity-awesome' node within the 12-meta-engine ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the antigravity-awesome requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform antigravity-awesome-specific tasks autonomously.
