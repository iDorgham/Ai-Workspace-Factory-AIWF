...
# Library Component: 12-meta-engine/meta-orchestration/v7-orchestration/regional_adapter.md
...
```
regional/
├── egypt_compliance.md         # Law 151/2020 checklist
├── mena-adaptations.json       # Feature flags, payment configs
└── rtl_layout_guide.md         # Arabic RTL implementation notes
```
...
*Library path: 12-meta-engine/meta-orchestration/v7-orchestration/regional_adapter.md*
