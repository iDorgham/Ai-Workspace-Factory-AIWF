...
/do --from=existing_prd.md --region=mena
```
...
- `docs/05-reports/{date}_{slug}_spec_lint_report.md` — Validation
...
- `docs/03-architecture/{date}_{slug}_db_erd.md`
...
*AIWF_Guide.md | Version 7.0.0 | docs/00-guides/*
