...
# 📊 Analysis Sector Rules

> [!IMPORTANT]
 All AI assets within the **Analysis** field MUST adhere to these governance constraints to ensure enterprise-grade output.

## Core Mandate
Data-driven business analysis and forecasting.

## Sector Constraints
1. **Industry Parity:** Output must match the top 1% of global Analysis standards.
