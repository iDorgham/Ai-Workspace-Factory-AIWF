...
Step 1b — SDD traceability (when the change is product/feature work)
  ...
  If the PR introduces new behavior without an updated spec: STOP — route to @Architect + @Guide (.ai/skills/sdd_spec_workflow.md).
...
Step 7 — Lessons Applied Check
  Review .ai/memory/lessons_learned.md last 3 entries
