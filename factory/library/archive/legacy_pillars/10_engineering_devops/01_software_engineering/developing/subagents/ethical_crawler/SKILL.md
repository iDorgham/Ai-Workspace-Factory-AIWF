...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'ethical-crawler' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the ethical-crawler requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform ethical-crawler-specific tasks autonomously.
