...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'export-packager' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the export-packager requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform export-packager-specific tasks autonomously.
