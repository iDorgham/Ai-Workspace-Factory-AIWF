...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'rule-updater' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the rule-updater requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform rule-updater-specific tasks autonomously.
