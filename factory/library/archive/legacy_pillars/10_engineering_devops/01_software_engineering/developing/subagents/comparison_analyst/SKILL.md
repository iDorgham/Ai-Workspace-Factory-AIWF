...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'comparison-analyst' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the comparison-analyst requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform comparison-analyst-specific tasks autonomously.
