...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'stacks' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the stacks requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform stacks-specific tasks autonomously.
