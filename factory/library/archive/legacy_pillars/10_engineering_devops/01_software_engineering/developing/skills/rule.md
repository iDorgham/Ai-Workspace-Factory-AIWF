...
# 💻 Developing Sector Rules

> [!IMPORTANT]
 All AI assets within the **Developing** field MUST adhere to these governance constraints to ensure enterprise-grade output.

## Core Mandate
Core software engineering and architectural logic.

## Sector Constraints
1. **Industry Parity:** Output must match the top 1% of global Developing standards.
...
- `domains`: Must include [Developing]
- `version`: 10.0.0
