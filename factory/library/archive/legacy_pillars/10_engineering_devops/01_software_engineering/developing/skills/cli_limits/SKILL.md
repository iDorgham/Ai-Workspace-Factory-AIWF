...
- **After a CLI task**: record the result in `docs/development/learning/CLI_USAGE_AND_RESULTS.md` so future runs can analyze usage and improve decisions (see guide and dev for the recording step).
...
- `.antigravity/skills/guide/SKILL.md` — Guide uses this skill when suggesting CLIs.
- `.antigravity/skills/dev/SKILL.md` — `/dev` uses this skill when choosing or invoking a CLI for a phase.