...
|------|----------|---------|
| `explore_library.md` | explore | Trace flows, refactor, security, DB |
| `shell_library.md` | shell | Preflight, migrate, build, test |
| `browser_library.md` | browser-use | Auth, i18n, QR, scans, exports |
...
Shorter, core prompts live in `.antigravity/subagents/` (explore.md, shell.md, browser_use.md).
