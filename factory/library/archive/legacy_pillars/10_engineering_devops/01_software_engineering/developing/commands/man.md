...
- **`/man tasks`:** Task manager. List: scan backlog, planning, planned, in-progress, done; output counts and active plan. Add: append to backlog. Move: use plan_move.md. Start/Focus: set active and run.
