...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'git' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the git requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform git-specific tasks autonomously.
