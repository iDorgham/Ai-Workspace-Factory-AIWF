...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'ide-setup' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the ide-setup requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform ide-setup-specific tasks autonomously.
