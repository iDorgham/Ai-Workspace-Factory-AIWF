...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'workflow' node within the 10-operations-qa ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the workflow requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform workflow-specific tasks autonomously.
