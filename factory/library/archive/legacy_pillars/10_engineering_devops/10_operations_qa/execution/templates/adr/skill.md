...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'adr' node within the 10-operations-qa ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the adr requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform adr-specific tasks autonomously.
