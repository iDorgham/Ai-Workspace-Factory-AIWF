...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'bug-report' node within the 10-operations-qa ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the bug-report requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform bug-report-specific tasks autonomously.
