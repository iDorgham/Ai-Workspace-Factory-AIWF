...
## 1. Purpose
This skill encapsulates absolute tactical dominance in **Sound Effects & Audio Design**. It serves as an executable knowledge block for agents to parse and implement hyper-optimized solutions matching 2026 industry standards.
...
def apply_sound_effects_&_audio_design(context):
