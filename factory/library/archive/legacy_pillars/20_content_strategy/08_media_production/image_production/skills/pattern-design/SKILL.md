...
## 1. Purpose
This skill encapsulates absolute tactical dominance in **Pattern Design & Seamless Textures**. It serves as an executable knowledge block for agents to parse and implement hyper-optimized solutions matching 2026 industry standards.
...
def apply_pattern_design_&_seamless_textures(context):
