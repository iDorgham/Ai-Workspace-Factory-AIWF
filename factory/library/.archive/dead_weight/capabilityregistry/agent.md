...
agents:
  ...
  - agent_id: design-system
    ...
    definition_file: .ai/agents/design_system.md
  - agent_id: content
    handles: ["@Content"]
    tier: Quality
  ...
  - agent_id: contract-lock
    ...
    definition_file: .ai/agents/contract_lock.md
  - agent_id: context-slicer
    ...
    definition_file: .ai/agents/context_slicer.md
  ...
  - agent_id: visual-qa
    ...
    definition_file: .ai/agents/visual_qa.md
  - agent_id: brand-guardian
    ...
    definition_file: .ai/agents/brand_guardian.md
  - agent_id: tutor
    handles: ["@Tutor"]
    tier: Learning
  ...
  - agent_id: error-detective
    ...
    definition_file: .ai/agents/error_detective.md
  - agent_id: knowledge-synthesizer
    ...
    definition_file: .ai/agents/knowledge_synthesizer.md
  - agent_id: debugger
    handles: ["@Debugger"]
    tier: Quality
  ...
  - agent_id: dependency-manager
    ...
    definition_file: .ai/agents/dependency_manager.md
  - agent_id: runtime-orchestrator
    ...
    definition_file: .ai/agents/runtime_orchestrator.md
  ...
  - agent_id: devops-engineer
    ...
    definition_file: .ai/agents/devops_engineer.md
  - agent_id: integration-specialist
    ...
    definition_file: .ai/agents/integration_specialist.md
  - agent_id: mobile-developer
    ...
    definition_file: .ai/agents/mobile_developer.md
```
