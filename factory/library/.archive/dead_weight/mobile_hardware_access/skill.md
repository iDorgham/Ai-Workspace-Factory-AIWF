...
# 🔌 Mobile Hardware Access (Camera, Haptics, GPS)

> **STATUS: CONSOLIDATED**
> **MASTER HUB:** [app-developing-mastery](../app-developing-mastery/SKILL.md)

This skill has been merged into its parent App Developing Mastery Hub to maintain a single source of truth for all native mobile hardware protocols.
