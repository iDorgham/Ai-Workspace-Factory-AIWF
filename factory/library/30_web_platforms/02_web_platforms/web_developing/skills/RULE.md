...
# 🌐 Web Developing Sector Rules

> [!IMPORTANT]
 All AI assets within the **Web Developing** field MUST adhere to these governance constraints to ensure enterprise-grade output.

## Core Mandate
Modern web architectures (Next.js, React, RTL).

## Sector Constraints
1. **Industry Parity:** Output must match the top 1% of global Web Developing standards.
...
- `domains`: Must include [Web Developing]
- `version`: 10.0.0
