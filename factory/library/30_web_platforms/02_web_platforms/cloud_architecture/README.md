...
# Cloud Architecture Index

- [SentinelCloudArchitecture](./agents/SentinelCloudArchitecture/AGENT.md) - `agents:02-web-platforms/cloud-architecture/SentinelCloudArchitecture`
- [cloud-architecture-mastery](./skills/cloud-architecture-mastery/SKILL.md) - `skills:02-web-platforms/cloud-architecture/cloud-architecture-mastery`
