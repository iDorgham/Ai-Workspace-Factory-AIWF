...
2. `.ai/skills/bilingual_rtl_first.md` — RTL layout rules and next-intl setup
3. `.ai/skills/govtech_tone_content.md` — formal Arabic register for gov-tech projects
4. `.ai/skills/multi_currency_localization.md` — Arabic-Indic numerals and EGP/currency formatting
5. `.ai/context/project_type.md` — whether the active project is luxury-hospitality or gov-tech (register differs)
...
For luxury hospitality projects, validates Arabic copy against brand_grammar.md luxury register:
...
## Skills Used
- `.ai/skills/bilingual_rtl_first.md` — Core RTL/i18n implementation patterns
- `.ai/skills/govtech_tone_content.md` — Egyptian government Arabic register
- `.ai/skills/multi_currency_localization.md` — EGP formatting, Arabic-Indic numerals
- `.ai/skills/accessibility_wcag.md` — ARIA labels must also be translated
- `.ai/skills/brand_grammar_emotional_intent.md` — Luxury vs gov-tech Arabic voice
