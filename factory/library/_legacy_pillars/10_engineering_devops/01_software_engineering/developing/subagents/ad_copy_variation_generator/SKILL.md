...
# 🧠 SKILL: Ad Copy Variation Generator
...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'ad-copy-variation-generator' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the ad-copy-variation-generator requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform ad-copy-variation-generator-specific tasks autonomously.
