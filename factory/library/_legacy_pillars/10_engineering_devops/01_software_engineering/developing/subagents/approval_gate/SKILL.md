...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'approval-gate' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the approval-gate requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform approval-gate-specific tasks autonomously.
