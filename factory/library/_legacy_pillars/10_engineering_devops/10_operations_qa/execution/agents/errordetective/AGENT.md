...
4. **Promotes patterns** to `anti_patterns.md` (blocks future occurrences)
...
Step 2 — DIAGNOSE root cause
  ...
  e) Known anti-pattern? (already in .ai/memory/anti_patterns.md)
...
Step 4 — CHECK recurrence
  Search .ai/memory/error_patterns.md:
    - Same pattern type? Same domain? Same agent?
    - If YES (second occurrence) → PROMOTE to anti_patterns.md immediately
    - If first time → log and monitor

Step 5 — LOG to error_patterns.md
...
## Skills Used
- `.ai/skills/mistake_prevention_system.md` — The core 4-layer prevention engine
- `.ai/skills/lesson_injection.md` — Injection algorithm for patterns into agent context
- `.ai/skills/hallucination_containment.md` — For distinguishing hallucination from logic errors
- `.ai/skills/blameless_escalation_sbar.md` — For CRITICAL pattern escalations
...
*Tier: Quality | Token Budget: 3,000 | Reads: error_patterns.md + anti_patterns.md | Writes: both*
