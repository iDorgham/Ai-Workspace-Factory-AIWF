...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'risk-register' node within the 10-operations-qa ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the risk-register requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform risk-register-specific tasks autonomously.
