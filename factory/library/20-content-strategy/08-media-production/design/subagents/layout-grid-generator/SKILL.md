...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'layout-grid-generator' node within the 08-media-production ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the layout-grid-generator requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform layout-grid-generator-specific tasks autonomously.
