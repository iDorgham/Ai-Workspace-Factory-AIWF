...
# 🧊 3D Production Sector Rules

> [!IMPORTANT]
> All AI assets within the **3D Production** field MUST adhere to these governance constraints to ensure enterprise-grade output.

## Core Mandate
3D modeling, lighting, and material rendering.

## Sector Constraints
1. **Industry Parity:** Output must match the top 1% of global 3D Production standards.
...
- `domains`: Must include [3D Production]
- `version`: 10.0.0
