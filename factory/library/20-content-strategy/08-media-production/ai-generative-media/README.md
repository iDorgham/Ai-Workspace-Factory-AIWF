...
# Ai Generative Media Index

- [SentinelAiGenerativeMedia](./agents/SentinelAiGenerativeMedia/AGENT.md) - `agents:08-media-production/image-production/SentinelAiGenerativeMedia`
- [ai-generative-media-mastery](./skills/ai-generative-media-mastery/SKILL.md) - `skills:08-media-production/image-production/ai-generative-media-mastery`
