...
# 📸 Image Production Sector Rules

> [!IMPORTANT]
> All AI assets within the **Image Production** field MUST adhere to these governance constraints to ensure enterprise-grade output.

## Core Mandate
AI-generative and static asset production.

## Sector Constraints
1. **Industry Parity:** Output must match the top 1% of global Image Production standards.
...
- `domains`: Must include [Image Production]
- `version`: 10.0.0
