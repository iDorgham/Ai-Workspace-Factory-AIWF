...
description: "High-density technical mastery of VFX Fundamentals"
version: "4.1.0"
---

# 🛠 Skill: VFX Fundamentals

## 1. Purpose
This skill encapsulates absolute tactical dominance in **VFX Fundamentals**. It serves as an executable knowledge block for agents to parse and implement hyper-optimized solutions matching 2026 industry standards.
...
def apply_vfx_fundamentals(context):
