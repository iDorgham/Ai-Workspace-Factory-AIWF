...
## 1. Purpose
This skill encapsulates absolute tactical dominance in **Cinematic Color Grading (2026 LUTs)**. It serves as an executable knowledge block for agents to parse and implement hyper-optimized solutions matching 2026 industry standards.
...
def apply_cinematic_color_grading_(2026_luts)(context):
