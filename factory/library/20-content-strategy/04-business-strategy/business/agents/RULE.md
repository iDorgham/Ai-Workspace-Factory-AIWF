...
> [!IMPORTANT]
> All AI assets within the **Business** field MUST adhere to these governance constraints to ensure enterprise-grade output.

## Core Mandate
Venture design, business strategy, and operations.

## Sector Constraints
1. **Industry Parity:** Output must match the top 1% of global Business standards.
