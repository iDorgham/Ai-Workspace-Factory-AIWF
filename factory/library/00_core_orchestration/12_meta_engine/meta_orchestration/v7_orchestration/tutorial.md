...
6. **Log the session** → `docs/00-guides/{date}_tutorial_session.md` with notes and user answers.
...
Your tutorial session has been saved to:
  docs/00-guides/{date}_tutorial_session.md
...
For more detail on any command:
  Read docs/00-guides/AIWF_Guide.md
...
`docs/00-guides/{YYYY-MM-DD}_tutorial_session.md`
