...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'research' node within the 05-data-analytics ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the research requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform research-specific tasks autonomously.
