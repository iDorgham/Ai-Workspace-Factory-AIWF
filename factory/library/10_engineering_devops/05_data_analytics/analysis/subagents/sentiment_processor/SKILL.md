...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'sentiment-processor' node within the 05-data-analytics ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the sentiment-processor requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform sentiment-processor-specific tasks autonomously.
