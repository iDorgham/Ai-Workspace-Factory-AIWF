...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'release-gate-checker' node within the 10-operations-qa ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the release-gate-checker requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform release-gate-checker-specific tasks autonomously.
