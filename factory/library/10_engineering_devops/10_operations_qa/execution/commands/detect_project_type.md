...
> **Scope:** Workspace analysis, project_type.md auto-population
...
```
Read:
- .ai/context/project_type.md → Current configuration (if any)
...
```yaml
# .ai/context/project_type.md — update with detected values
...
✅ `.ai/context/project_type.md` updated with detected values

**If confidence is Low:**
⚠️ Low confidence detection — please review and manually adjust configuration in `.ai/context/project_type.md`
...
# Or edit directly
# .ai/context/project_type.md — edit project_type field
```
...
- **All agents:** Read project_type.md to adapt behavior
