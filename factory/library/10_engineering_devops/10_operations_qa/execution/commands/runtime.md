...
1. Resolve repo root; discover optional `sos/runtime_state.md` (repo root) + `.ai/plans/active/features/*/sos/runtime_state.md`. Bootstrap: **`.ai/templates/sos-root/runtime_state.md`**.
...
**DMP:** Step 0 — load `.ai/memory/anti_patterns.md` before mutating disk.
