...
**SDD default:** **`/plan [phase]/[spec]`** + **`.ai/templates/sdd-spec/`** — see **`docs/workspace/reference/feature_plan_package_layout.md`**. Use this folder for **`/plan --legacy`**, migration, or extra **`phases/`** / **`prompts/`** depth.
...
**Canonical layout spec:** **`docs/workspace/reference/feature_plan_package_layout.md`**
...
| `test_plan.md` | TDD: tests before implementation (optional) |
...
| `sos/` | **Not in this zip-tree** until SOS runs — create **`manifest.md`**, **`prompts/`**, optional **`runtime_state.md`** per **`docs/workspace/reference/feature_plan_package_layout.md`** |
