...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'test-plan' node within the 10-operations-qa ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the test-plan requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform test-plan-specific tasks autonomously.
