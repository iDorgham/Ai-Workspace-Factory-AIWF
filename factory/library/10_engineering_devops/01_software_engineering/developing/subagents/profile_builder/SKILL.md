...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'profile-builder' node within the 01-software-engineering ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the profile-builder requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform profile-builder-specific tasks autonomously.
