...
skill: shadcn_atomic_design.md    → use button variants, not raw HTML
skill: playwright_e2e.md          → use page objects, not raw locators
skill: owasp_zero_trust.md        → validate all inputs at route layer
...
For ERROR REPORTS:
  Use the capture format in mistake_prevention_system.md — structured, not narrative
...
| lessons_learned.md | 1,800 tok | 240 tok | 87% | Domain + recency filter |
