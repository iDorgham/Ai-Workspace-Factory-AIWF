...
Also set `trace_id_last` in `sos/runtime_state.md` YAML to the latest trace.
...
2. **@ErrorDetective** classifies → suggested agent from `.ai/agents/capability_registry.md`.
...
*Pairs with: `.ai/skills/runtime_adaptive_loop.md` · `.ai/skills/auto_optimization_loop.md`*