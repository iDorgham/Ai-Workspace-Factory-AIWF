...
- [ ] Anti-pattern scan completed (mistake_prevention_system.md Layer 1)?
- [ ] Relevant lessons_learned.md entries read?
...
### 3. PLAN STEP CHECK
- [ ] Am I working on the correct plan step? (.ai/plans/active/current_sprint.md)
- [ ] **SDD:** Is the active slice **`.ai/plans/active/features/[phase]/[spec]/plan.md`** (and phase **`manifest.md`** if multi-spec) identified? See **`.ai/skills/sdd_spec_workflow.md`**
