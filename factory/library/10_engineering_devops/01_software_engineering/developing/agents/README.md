...
| **Backend-Database** | Schema, migrations, queries | `roles/backend_database.md` |
| **Backend-API** | API routes | `roles/backend_api.md` |
...
| Agent | When to use | File |
|-------|-------------|------|
| **Code Review** | Review PR or changes | `scenarios/code_review.md` |
| **Security Audit** | Full security pass | `scenarios/security_audit.md` |
