...
3. Read .ai/context/design_system.md for component architecture rules
4. Under SDD: align UI with the active spec — .ai/plans/active/features/[phase]/[spec]/plan.md (AC) and design.md when present (.ai/skills/sdd_spec_workflow.md)
...
---
* | Context: .ai/context/design_system.md*
