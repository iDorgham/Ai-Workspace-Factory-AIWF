...
- [SentinelBackend](./agents/SentinelBackend/AGENT.md) - `agents:01-software-engineering/backend/SentinelBackend`
- [backend-mastery](./skills/backend-mastery/SKILL.md) - `skills:01-software-engineering/backend/backend-mastery`
