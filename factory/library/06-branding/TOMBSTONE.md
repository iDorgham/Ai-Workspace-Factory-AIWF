# TOMBSTONE — factory/library/06-branding/
...
- `factory/library/00_core_orchestration/` — brand governance contracts
- `factory/library/50_intelligence_marketing/` — brand intelligence and marketing assets
