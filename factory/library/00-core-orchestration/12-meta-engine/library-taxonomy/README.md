...
# Library Taxonomy Index

- [SentinelLibraryTaxonomy](./agents/SentinelLibraryTaxonomy/AGENT.md) - `agents:12-meta-engine/library-taxonomy/SentinelLibraryTaxonomy`
- [library-taxonomy-mastery](./skills/library-taxonomy-mastery/SKILL.md) - `skills:12-meta-engine/library-taxonomy/library-taxonomy-mastery`
