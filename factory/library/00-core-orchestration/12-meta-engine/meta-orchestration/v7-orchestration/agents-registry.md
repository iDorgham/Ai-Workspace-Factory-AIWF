...
# Library Component: 12-meta-engine/meta-orchestration/v7-orchestration/agents-registry.md
...
agents:
  ...
  healing_bot_v2:
    ...
    responsibilities:
      ...
      - "Append-only repair logging to .ai/logs/healing-bot.md"
...
*Library path: 12-meta-engine/meta-orchestration/v7-orchestration/agents-registry.md*
