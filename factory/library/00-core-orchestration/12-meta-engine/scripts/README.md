...
- [SentinelScripts](./agents/SentinelScripts/AGENT.md) - `agents:12-meta-engine/scripts/SentinelScripts`
- [scripts-mastery](./skills/scripts-mastery/SKILL.md) - `skills:12-meta-engine/scripts/scripts-mastery`
