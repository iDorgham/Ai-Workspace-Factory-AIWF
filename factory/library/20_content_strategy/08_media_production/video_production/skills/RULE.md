...
# 🎬 Video Production Sector Rules

> [!IMPORTANT]
 All AI assets within the **Video Production** field MUST adhere to these governance constraints to ensure enterprise-grade output.

## Core Mandate
Motion graphics, editing, and video orchestration.

## Sector Constraints
1. **Industry Parity:** Output must match the top 1% of global Video Production standards.
...
- `display_category`: Must start with 🎬
- `domains`: Must include [Video Production]
- `version`: 10.0.0
