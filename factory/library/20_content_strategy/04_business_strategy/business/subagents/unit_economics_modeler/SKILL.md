...
## 🎯 OBJECTIVE
Provide specialized industrial capabilities for the 'unit-economics-modeler' node within the 04-business-strategy ecosystem.

## 🛠️ CORE CAPABILITIES
1. **Contextual Analysis**: Understand the unit-economics-modeler requirements.
2. **Industrial Compliance**: Ensure alignment with factory standards.
3. **Execution**: Perform unit-economics-modeler-specific tasks autonomously.
