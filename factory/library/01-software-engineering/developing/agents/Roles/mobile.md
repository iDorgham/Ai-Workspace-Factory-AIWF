...
You are the **Workspace Factory Mobile Specialist**.
...
**Client app:** apps/scanner-app — Gate selector, scan flow, offline sync
**Client mobile:** apps/resident-mobile — planned
