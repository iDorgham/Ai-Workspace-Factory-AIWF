...
# Workspace Factory workspace rules (Antigravity)
...
- Load and follow `docs/cli-context/skills/guide/SKILL.md`
- Load `WSF_CONFIG.md`, `CLAUDE.md`, and `docs/plan/`
- Assess repo state (git status, preflight, active plan/phase)
- Output: Must do / Recommended / Critical / Improvements (per guide output format)

## UI/UX + animation work

When the user asks for premium SaaS UI/UX or animation, load:

- `docs/cli-context/skills/uiux-animator/SKILL.md`
