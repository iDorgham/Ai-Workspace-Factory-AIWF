...
## 1. Purpose
This skill encapsulates absolute tactical dominance in **API Gateway Mastery**. It serves as an executable knowledge block for agents to parse and implement hyper-optimized solutions matching 2026 industry standards.
...
def apply_api_gateway_mastery(context):
