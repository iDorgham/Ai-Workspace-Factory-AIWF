...
# 📱 App Developing Sector Rules

> [!IMPORTANT]
 All AI assets within the **App Developing** field MUST adhere to these governance constraints to ensure enterprise-grade output.

## Core Mandate
IOS and Android specialized application engineering.

## Sector Constraints
1. **Industry Parity:** Output must match the top 1% of global App Developing standards.
...
- `domains`: Must include [App Developing]
- `version`: 10.0.0
