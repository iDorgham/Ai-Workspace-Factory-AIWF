...
id: commands:execution/commands/branch
version: 10.0.0
...
```
1. @Automation reads .ai/plans/active/features/booking-flow.md
...
6. Updates .ai/plans/active/audit/git-audit.md
```
...
Plan linked: .ai/plans/active/features/booking-flow.md
