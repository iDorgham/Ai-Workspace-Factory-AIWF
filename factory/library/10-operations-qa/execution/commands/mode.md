...
id: commands:execution/commands/mode
version: 10.0.0
...
2. **Update project configuration:**
   ```yaml
   # .ai/context/project-type.md — update mode field
   mode: [new-mode]
   ```
...
| "Mode switch failed" | Could not update project-type.md | Check file permissions, retry |
